...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String name,state,department,grade,time,password,email, distance;
    ...
    private void register() {
        ...
        distance = et_distance.getText().toString().trim();
        time = et_time.getText().toString().trim();
        password = et_password.getText().toString().trim();
        department = et_department.getText().toString().trim();

        if(name.isEmpty() || grade.isEmpty() || state.isEmpty() || distance.isEmpty() || time.isEmpty() || password.isEmpty() || department.isEmpty())
            ...
            Toast.makeText(RegisterActivity.this, R.string.yildiz_edu_confirm, Toast.LENGTH_SHORT).show();
        }else
